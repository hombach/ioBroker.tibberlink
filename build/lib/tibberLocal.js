...
class TibberLocal extends tibberHelper_1.TibberHelper {
    ...
    constructor(adapter) {
        ...
        this.TestData = ``;
        this.TestMode = true;
    ...
    async extractAndParseSMLMessages(pulse, transfer, forceMode = false) {
        ...
        for (const match of messages) {
            ...
            Pulse mode 3 parse result: {"name":"Import_total","value":34323363.3,"unit":"kWh"}
            parse SML group 5: 00000007fdd4f5c6
            parse SML group 4: 59
            parse SML group 3: fc
            parse SML group 2: 1e
            parse SML group 1: 0100010800ff
            */
            /*
            // example HEX strings  -  meter mode 3 e.g. for "ISKRA ISK00 7034" meters
            TestData: string = ``;
            Pulse mode 3 parse result: {"name":"Import_total","value":24977,"unit":"kWh"}
            parse SML group 5: 000000000ee32fcb
            parse SML group 4: 59
            parse SML group 3: ff
            parse SML group 2: 1e
            parse SML group 1: 0100010800ff
            parse SML overall compliance: 77070100010800ff65000101a001621e52ff59000000000ee32fcb01
            */
            ...
            } else if (match[3].toLowerCase() == "fd") {
                result.value = result.value / 1000;
            } else if (match[3].toLowerCase() == "fc") {
