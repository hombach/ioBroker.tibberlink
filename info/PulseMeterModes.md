...
Reference notes for the local Pulse telegram parsing in [`src/lib/tibberLocal.ts`](../src/lib/tibberLocal.ts).
...
4. Add a regression test in [`src/lib/tibberLocal.test.ts`](../src/lib/tibberLocal.test.ts) using the real
